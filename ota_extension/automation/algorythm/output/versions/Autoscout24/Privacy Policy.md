...
Diese Datenschutzhinweise erläutern, wie die AutoScout24 GmbH, Tölzer Str. 16, 82031 Grünwald („AutoScout24 Deutschland“), die Landesgesellschaften der [AutoScout24-Gruppe](https://www.autoscout24.de/unternehmen/ueber-uns/) (siehe dazu unter Ziffer 1.2) sowie die AutoScout24 Smyle GmbH, Tölzer Str. 16, 82031 Grünwald („smyle“) (siehe dazu unter Ziffer 1.4) mit personenbezogenen Daten umgehen und welche Rechte Sie als Betroffener haben. Bitte beachten Sie, dass die oben genannten Unternehmen individuell verantwortlich im Sinne des Datenschutzrechts sind und dass die folgenden Informationen daher im Rahmen der jeweiligen Verantwortung erteilt werden.

Zum AutoScout24 Privacy Manager gelangen Sie hier: [AutoScout24 Privacy Manager](https://www.autoscout24.de/consent-management/).

**1\. Wann ist AutoScout24 Deutschland Verantwortlicher und wann andere Landesgesellschaften der AutoScout24-Gruppe**

**1.1 AutoScout24 Deutschland**

Diese Datenschutzhinweise beschreiben, wie AutoScout24 Deutschland als Verantwortlicher im Sinne des geltenden Datenschutzrechts Ihre personenbezogenen Daten verarbeitet, wenn Sie eine Website, eine App oder einen Social Media-Kanal der [AutoScout24-Gruppe](https://www.autoscout24.de/unternehmen/ueber-uns/) aufrufen und dabei Ihr Verhalten auf einer dieser Websites für statistische Zwecke oder zu Online-Marketingzwecken ausgewertet oder zur bedarfsgerechten Gestaltung verwendet wird.

**1.2 Landesgesellschaften der [AutoScout24-Gruppe](https://www.autoscout24.de/unternehmen/ueber-uns/)**

Daneben sind die jeweiligen Landesgesellschaften der [AutoScout24-Gruppe](https://www.autoscout24.de/unternehmen/ueber-uns/) in einzelnen europäischen Ländern jeweils eigenständig verantwortlich im Sinne des geltenden Datenschutzrechts, wenn Sie
...
Die Verantwortlichkeiten der jeweiligen Landesgesellschaften der [AutoScout24-Gruppe](https://www.autoscout24.de/unternehmen/ueber-uns/) (die jeweilige Landesgesellschaft wird im Einzelnen mit „AutoScout24“bezeichnet) gliedern sich wie folgt:
...
| **Frankreich** | https://www.autoscout24.fr/ | AutoScout24 France SAS, 126 avenue du Général Leclerc, 92100 Boulogne-Billancourt |
| **Italien** | https://www.autoscout24.it/ | AutoScout24 Italia S.p.a., via Battaglia 71/C, 35020 Albignasego – Padova, Italien |
| **Niederlande** | https://www.autoscout24.nl/ | AutoScout24 Nederland B.V., c/o Epicenter Amsterdam, Fred Roeskestraat 115, NL-1076 EE Amsterdam |
...
Weitere Informationen zum Facebook Login und den Privatsphäre-Einstellungen entnehmen Sie bitte der [Datenschutzerklärung](https://de-de.facebook.com/privacy/policy/) und den [Nutzungsbedingungen](https://www.facebook.com/legal/terms) von Facebook.
...
Wenn Sie eingewilligt haben, übermitteln wir dem Händler auf unserer Website, dem Sie im Rahmen des Kontaktformulars eine Anfrage gesendet haben, Ihre nutzungsbasierten Informationen. Um Ihnen eine bestmögliche und individuelle Beratung zu gewährleisten, leiten wir daher u.a. die folgenden Daten über die Nutzung unserer Website weiter: Am häufigsten angesehenes Fahrzeug und Durchschnittspreis, Preisspanne kontaktierter Fahrzeug-Inserate, gesuchte Ort, auf der AutoScout24-Website verbrachte Zeit, Datum der letzten Kontaktanfrage, Favoriten und bevorzugte Kontaktmethode, Interesse an Leasing.

Sie können die Einwilligung jederzeit in den [Datenschutz-Einstellungen](https://www.autoscout24.de/consent-management/) oder [hier](mailto:widerspruch@autoscout24.de) widerrufen.
...
**2.2.1 Kontaktformular Händler-Anfrage Jaguar Land Rover Deutschland GmbH**

Händler von Fahrzeugen der Marke Jaguar Land Rover arbeiten mit der Jaguar Land Rover Deutschland GmbH, Campus Kronberg 7, 61476 Kronberg im Taunus („JLR Deutschland“) als Kooperationspartner. Zur Abwicklung Ihrer Anfrage werden daher, wenn Sie als Interessent eine Anfrage über das Kontaktformular an einen Händler von JLR-Fahrzeugen senden, Ihre Daten (Name, E-Mail- Adresse, ggf. Telefonnummer, Inhalt der Kontaktanfrage) auch an JLR Deutschland weitergeleitet. Sie können daher zur Abwicklung Ihrer Anfrage sowohl vom Händler als auch von der JLR Deutschland als Kooperationspartner des Händlers kontaktiert werden. JLR Deutschland und der Händler verwenden Ihre Daten, um Ihre Anfrage effizient zu bearbeiten und eine reibungslose Kommunikation zu ermöglichen. Hierdurch wird die Servicequalität für Interessenten von Fahrzeugen der Marke Jaguar Land Rover kontinuierlich verbessert und die Abwicklung von Waren- und Serviceanfragen optimiert.

Die mit JLR Deutschland kooperierenden Händler haben uns zur Weitergabe der Daten an JLR Deutschland beauftragt. Eine darüberhinausgehende Weitergabe an Dritte erfolgt nicht. Ihre Daten werden gespeichert, solange sie für die genannten Zwecke erforderlich sind und werden gelöscht, sobald der Zweck der Verarbeitung entfällt.

Weitere Informationen darüber, wie JLR Deutschland Ihre Daten verarbeitet sowie Informationen zu Ihren Rechten finden Sie unter [https://www.landrover.de/privacy-policy/index.html](https://www.landrover.de/privacy-policy/index.html)

**Rechtsgrundlage:** Diese Verarbeitungen erfolgen gemäß Art. 6 Abs. 1 b) DSGVO zur Vertrags-/Auftragserfüllung Ihrer Kontakt-Anfrage sowie gemäß Art. 6 Abs. 1 f) DSGVO bei auf Grundlage des berechtigten Interesses des Händlers und JLR Deutschland einer effizienten Kontaktaufnahme.
...
Wenn Sie uns als **Händler** Ihre IBAN übermitteln, verwenden wir zur Validierung internationaler Bankverbindungen den Dienst von [www.iban.com](https://www.iban.com/), betrieben von GW Solyushans Ltd., Asen Zlatarov 16, 4000 Plovdiv, Bulgarien („IBANCOM“). IBANCOM ist eine Online-Plattform zur Überprüfung von IBANs sowie zur Ermittlung zugehöriger Bankdaten wie BIC/SWIFT-Codes. Zur Nutzung des Dienstes übermitteln wir die jeweilige IBAN an IBANCOM. Der Dienst wird von uns durch eine technische Schnittstelle über unser Kundenmanagementsystem eingesetzt, um die Korrektheit der uns übermittelten IBANs zu prüfen und den entsprechenden BIC zu ermitteln. Die Datenverarbeitung dient der Überprüfung der Zahlungsinformationen im Rahmen der Vertragserfüllung und stellt die ordnungsgemäße Zahlungsabwicklung sowie die korrekte Durchführung von SEPA-Lastschriftmandaten sicher.

**Rechtsgrundlage:** Art. 6 Abs. 1 b) DSGVO (Vertragsanbahnung und -durchführung)
...
Beim Besuch unserer Facebook-Seite verarbeitet Facebook (Facebook Ireland Limited, 4 Grand Canal Square, Dublin, Irland; „Facebook“) Ihre IP-Adresse sowie weitere Informationen, die in Form von Cookies auf Ihrem PC vorhanden sind. Diese Informationen werden verwendet, um AutoScout24 als Betreiber der Facebook-Seiten statistische Informationen über die Inanspruchnahme der Facebook-Seite zur Verfügung zu stellen (sog. Insights-Daten). Nähere Informationen hierzu stellt Facebook unter folgendem Link zur Verfügung: [https://de-de.facebook.com/help/pages/insights](https://de-de.facebook.com/help/pages/insights) sowie in den facebook Datenschutzhinweisen [https://www.facebook.com/privacy/policy/](https://www.facebook.com/privacy/policy/). Mit Hilfe dieser anonymisierten Besucherstatistiken sind wir in der Lage die Qualität unserer Facebook Seite und unserer Inhalte zu bewerten. Diese Statistiken werden auf der Basis von Nutzungsdaten erstellt, die Facebook über Ihre Interaktion mit unserer Facebook-Fanpage erhebt. Auf die Erzeugung und Darstellung haben wir als Betreiber der Facebook-Fanpage keinen Einfluss.
...
Weitere Informationen dazu finden sie auf der Facebookseite unter folgendem Link: [https://www.facebook.com/legal/terms/page\_controller\_addendum](https://www.facebook.com/legal/terms/page_controller_addendum).
...
LinkedIn gewährleistet die Sicherheit der Verarbeitung von Mitgliederdaten und die Bereitstellung von Seiteneinblicken durch Umsetzung geeigneter technischer und organisatorischer Maßnahmen; weitere Informationen finden Sie hier: [https://security.linkedin.com/.](https://security.linkedin.com/)
...
Weitere Informationen dazu finden sie auf der LinkedIn unter [https://legal.linkedin.com/pages-joint-controller-addendum](https://legal.linkedin.com/pages-joint-controller-addendum) sowie in der Datenschutzerklärung von LinkedIn unter [https://www.linkedin.com/legal/privacy-policy](https://www.linkedin.com/legal/privacy-policy).
...
**3\. Zu welchen Zwecken und auf welcher Rechtsgrundlage verarbeitet AutoScout24 Ihre Daten?**
...
Weitere Informationen zum Facebook Login und den Privatsphäre-Einstellungen entnehmen Sie bitte der Datenschutzerklärung ([https://de-de.facebook.com/privacy/policy/](https://de-de.facebook.com/privacy/policy/)) und den Nutzungsbedingungen ([https://www.facebook.com/legal/terms](https://www.facebook.com/legal/terms)) von Facebook.

**Rechtsgrundlage:** Vertragsanbahnung und –durchführung, Art. 6 Abs. 1 b) DSGVO; berechtigtes Interesse, Art. 6 Abs. 1 f) DSGVO.

**3.1.2 Einbindung von YouTube-Videos**  
Wir nutzen die Plattform YouTube.com, um Videos einzustellen und öffentlich zugänglich zu machen. Youtube.com ist ein Angebot der YouTube, LLC, 901 Cherry Ave., San Bruno, CA 94066, USA („YouTube“). Wir verwenden YouTube ausschließlich im erweiterten Datenschutz-Modus, das heißt dass keine Daten über Sie als Nutzer an YouTube übertragen werden, wenn Sie die Videos nicht abspielen. Erst wenn Sie die Wiedergabe eines eingebundenen Videos durch Anklicken starten, werden Daten an YouTube übertragen. Wir haben auf diese Datenübertragung keinen Einfluss. YouTube erhält die Information, dass Sie die entsprechende Unterseite unserer Webseite aufgerufen haben. Dies erfolgt unabhängig davon, ob Sie ein Nutzerkonto bei YouTube eingerichtet haben. Wenn Sie ein Nutzerkonto bei Google oder YouTube eingerichtet haben, kann Google Ihre Nutzung ggf. mit Ihrem Nutzerkonto verknüpfen. YouTube kann dies für die Zwecke der Werbung, Marktforschung und/oder bedarfsgerechten Gestaltung ihrer Website nutzen.

Weitere Informationen zu Zweck und Umfang der Datenerhebung und ihrer Verarbeitung durch YouTube erhalten Sie in der Datenschutzerklärung von YouTube. Dort erhalten Sie auch weitere Informationen zu Ihren Rechten und Einstellungsmöglichkeiten zum Schutze Ihrer Privatsphäre: [https://policies.google.com/privacy?hl=de&gl=de](https://policies.google.com/privacy?hl=de&gl=de). YouTube ist ein Tochterunternehmen der Google LLC, 1600 Amphitheatre Parkway Mountain View, CA 94043, USA („Google“). Google verarbeitet Ihre personenbezogenen Daten auch in den USA und hat sich dem EU-US-Privacy-Shield unterworfen, wodurch der korrekte und sichere Datentransfer personenbezogener Daten von EU-Bürgern in die USA geregelt wird. Zudem verwendet Google die EU-Standardvertragsklauseln. Die Google Ads Datenverarbeitungsbedingungen, welche auf die Standardvertragsklauseln verweisen, finden Sie unter [https://business.safety.google/intl/de/adsprocessorterms/](https://business.safety.google/intl/de/adsprocessorterms/).

Wenn Sie eingewilligt haben, dass Daten von Ihnen durch eingebundene YouTube-Elemente verarbeitet werden, gilt diese Einwilligung als Rechtsgrundlage für die Datenverarbeitung. Die Einbindung von YouTube-Videos im erweiterten Datenschutzmodus erfolgt auf unserem berechtigten Interesse, Ihnen Inhalte in einer ansprechenden und optimierten Form zu präsentieren.

**Rechtsgrundlage**: Einwilligung, Art. 6 Abs. 1 lit. a) DSGVO, berechtigtes Interesse, Art. 6 Abs. 1 f) DSGVO.
...
Darüber hinaus erhebt AutoScout24 personenbezogene Daten über ein eigenes Analyse-Tool, um die Funktionalität unserer Angebote auszuwerten und die Ihnen bereitgestellten Angebote auf unserer Website zu optimieren (Verbesserung der Produktperformance). Hierzu werten wir unter anderem die Nutzung bestimmter Funktionen auf unserer Website aus, um die Website im Hinblick auf Effizienz, Bedienbarkeit und Nutzerfreundlichkeit gezielt zu optimieren (z.B. Verbesserung der Suchergebnisse). In diesem Zusammenhang erfolgt keine Weitergabe der Daten an Dritte.
...
Das Setzen von Cookies können Sie durch Deaktivierung der Cookies in Ihrem Webbrowser verhindern. Darüber hinaus können Sie im [AutoScout24 Privacy Manager](https://www.autoscout24.de/consent-management/) für unsere Websites und, bei Nutzung innerhalb der Apps für die betreffende App entscheiden, ob und in welchem Umfang Cookies bei der Nutzung unserer Websites bzw. entsprechende technische Services bei der Nutzung unserer Apps durch AutoScout24 Deutschland genutzt werden dürfen. Leider können Sie nur mit einer aktivierten Cookieannahme bzw. Annahme der technischen Services innerhalb der App alle Funktionalitäten unserer Angebote nutzen.

Wir arbeiten dabei mit folgenden Partnern:

**3.3.1 Adjust**

AutoScout24 Deutschland nutzt für unsere Apps zur Analyse der App-Nutzung den App-Analysedienst der Adjust GmbH (Saarbrücker Str. 38a, 10405 Berlin; "Adjust") ein. Der Adjust-Dienst ist nach dem ePrivacyseal (European Seal for your Privacy) der ePrivacyseal GmbH geprüft und zertifiziert worden (vgl. [https://www.eprivacy.eu/kunden/vergebene-siegel/](https://www.eprivacy.eu/kunden/vergebene-siegel/) ). Die durch die Verwendung der App gesammelten Informationen werden durch AutoScout24 Deutschland dazu verwendet, die Funktion und Nutzung der App zu analysieren, indem anonymisierte Auswertungen und Grafiken zum App-Nutzungsverhalten erstellt werden. Die Analysen werden ausschließlich zu Zwecken der Marktforschung sowie der Optimierung und bedarfsgerechten Gestaltung der App durch AutoScout24 Deutschland verwendet. Es werden dazu Ihre mobilen Identifier (etwa IDFA oder Google Play Services ID), bei Nutzung der Website IP- und Mac-Adresse, die unmittelbar nach Übermittlung anonymisiert werden, genutzt. Ein Rückschluss auf Ihre Person ist hierdurch nicht möglich. Nähere Informationen zum Datenschutz von Adjust finden Sie hier: [https://www.adjust.com/terms/privacy-policy/](https://www.adjust.com/terms/privacy-policy/).

**Rechtsgrundlage:** Einwilligung, Art. 6 Abs. 1 a) DSGVO, § 25 Abs. 1 TDDDG.

**3.3.2 Cheq**

Wir nutzen auf unseren Angeboten zum Zwecke der Sicherheit unserer Angebote und Webemaßnahmen Cheq Paradome, einen Service von Cheq (CHEQ AI Technologies (2018) Ltd, 23 Yehuda Halevi St. Tel-Aviv, 6513601, Israel; "Cheq"), einen Dienstleister Betrugserkennung und IT-Sicherheit. Cheq verarbeitet analysiert und Informationen über Ihr Surfverhalten und Nutzung ihrer IP Adress, insbeosndere dazu, um Sie von potentiell schädlichen Zugriffen auf unsere Website oder Zugriffen in betrügerischer Absicht zu unterscheiden.

Nähere Informationen zum Datenschutz von Cheq finden Sie hier: [https://cheq.ai/privacy-policy/](https://cheq.ai/privacy-policy/).

**Rechtsgrundlage:** Berechtigtes Interesse, Art. 6 Abs. 1 f) DSGVO, § 25 Abs. 2 TDDDG.

**3.3.3 Datadog**

AutoScout24 Deutschland verwendet Datadog (Datadog Inc., 620 8th Avenue, Floor 45, New York, NY 10018, USA; “Datadog”), um Ihnen unsere Apps bereitstellen zu können. Wir benötigen Datadog, um technische Fehler in der Funktionsweise unserer App erkennen zu können. Entsprechend werden Daten zur App-Verwendung in Bezug auf Systemabstürze und Fehler erfasst. Dabei werden Informationen zum verwendeten Gerät, zu der installierten App-Version sowie andere Informationen bezüglich der Soft- und Hardware des von Ihnen verwendeten mobilen Geräts erhoben und zur Fehlerbehebung eingesetzt.

Nähere Informationen zum Datenschutz von Datadog finden Sie hier: [https://www.datadoghq.com/legal/privacy/](https://www.datadoghq.com/legal/privacy/).
...
Im Auftrag von AutoScout24 Deutschland wird Google diese Informationen benutzen, um Ihre Nutzung der Website auszuwerten, um Reports über die Websiteaktivitäten zusammenzustellen und um weitere mit der Websitenutzung und der Internetnutzung verbundene Dienstleistungen gegenüber AutoScout24 Deutschland zu erbringen, wie etwa die algorithmenbasierte Erstellung demographischer Reports. Die im Rahmen von Google Analytics von Ihrem Browser übermittelte IP-Adresse wird nicht mit anderen Daten von Google zusammengeführt.

Nähere Informationen zu Nutzungsbedingungen und Datenschutz finden Sie unter [https://marketingplatform.google.com/about/analytics/terms/de/](https://marketingplatform.google.com/about/analytics/terms/de/) bzw. unter [https://www.google.de/intl/de/policies/](https://www.google.de/intl/de/policies/). Wir weisen Sie darauf hin, dass auf dieser Website Google Analytics um den Code „gat.\_anonymizeIp();“ erweitert wurde, um eine anonymisierte Erfassung von IP-Adressen (sog. IP-Masking) zu gewährleisten.

**Rechtsgrundlage:** Einwilligung, Art. 6 Abs. 1 a) DSGVO, § 25 Abs. 1 TDDDG.

**3.3.5 Google Firebase Crashlytics**

AutoScout24 Deutschland nutzt für unsere App zur Verbesserung unserer Apps, insbesondere zur Vermeidung von Systemabstürzen Google Firebase Crashlytics (Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland"; “Google Firebase Crashlytics”). Es werden über das Crashlytics-Tool Daten zur App-Verwendung in Bezug auf Systemabstürze und Fehler erfasst. Dabei werden Informationen zum verwendeten Gerät, zu der installierten App-Version sowie andere Informationen bezüglich der Soft- und Hardware des von Ihnen verwendeten mobilen Geräts erhoben und zur Fehlerbehebung eingesetzt. Nähere Informationen zum Datenschutz von Google Firebase Crashlytics finden Sie hier: [https://policies.google.com/privacy](https://policies.google.com/privacy).

**Rechtsgrundlage:** Berechtigtes Interesse, Art. 6 Abs. 1 f) DSGVO, § 25 Abs. 2 TDDDG.

**3.3.6 Iterable Ireland Ltd.**

Wir verwenden Iterable, einen Dienst von Iterable Ireland, Ltd., 8th Floor, Block E, Iveagh Court, Harcourt Road, Dublin 2, Ireland („Iterable“). Iterable ist ein Tochterunternehmen von Iterable, Inc., 201 Spear Street, Suite 1050, San Francisco, CA 94105, USA. Iterable ist eine Anwendung für die kanalübergreifende Kommunikation und ermöglicht den Versand sowie die Verwaltung von Benachrichtigungen über verschiedene Kanäle wie E-Mail, Web-/Push-Benachrichtigungen, Web/In-App-Banner, Benachrichtigungszentrum, eingebettete Nachrichten oder SMS.

Wir übermitteln Ihre Daten (E-Mail-Adresse, ggf. Name, Vorname, Telefonnummer, Adresse, Fahrzeugdaten, gespeicherte Suchen, Favoriten und Lead-Informationen, falls zutreffend) an Iterable, um die Kommunikation gezielt auf Ihre Bedürfnisse abzustimmen und Ihnen relevante Inhalte bereitzustellen. Soweit Sie unseren Marketing-Benachrichtigungen zugestimmt haben, nutzen wir Iterable zur Verwaltung von Marketingkampagnen und dem Versand von Angeboten (u.a. Newsletter-Versand). Sofern Sie eingewilligt haben, erfasst Iterable Ihr Verhalten auf unserer Website unter Verwendung von Cookies, Web-Beacons, Pixel-Tags und anderen ähnlichen Technologien und wertet aus, wie Sie mit den entsprechenden Nachrichten (z.B. Newslettern) interagieren. Darüber hinaus verwenden wir Iterable für unsere servicebezogene Kommunikation (z.B. Kaufbestätigsungs-Mails, Nachrichten im Zusammenhang mit Ihrem Account/Anmeldung).

Nähere Informationen zum Datenschutz bei Iterable finden Sie unter: [https://iterable.com/de/trust/privacy-policy/](https://iterable.com/de/trust/privacy-policy/).

Wenn Sie eingewilligt haben, gilt diese Einwilligung als Rechtsgrundlage für die Datenverarbeitung. Erfolgt die Verarbeitung für Nachrichten, die im Zusammenhang mit Ihrem Vertrag stehen, dient dies der Erfüllung des Vertrags, dessen Vertragspartei Sie sind bzw. auf Grundlage unseres berechtigten Interesses, Ihnen Inhalte bzw. Nachrichten zu versenden, die im Zusammenhang mit Ihrem Vertrag stehen.

**Rechtsgrundlage:** Für personalisierte Werbung: Einwilligung, Art. 6 Abs. 1 a) DSGVO, § 25 Abs. 1 TDDDG; für die Vertragserfüllung bzw. Nachrichten im Zusammenhang mit der Vertragserfüllung: Art 6 Abs. 1 lit. b) DSGVO bzw. berechtigtes Interesse, Art. 6 Abs. 1 lit f) DSGVO.

**3.3.7 Microsoft Clarity**

Wir verwenden den Dienst Clarity, der uns von Microsoft Ireland Operations Limited (Microsoft) bereitgestellt wird. Mithilfe von Clarity erfassen wir unter Zuordnung zu einer einzigartigen ID, wie Sie unsere Website nutzen und mit ihr interagieren, und zwar mithilfe von Verhaltensmetriken, Heatmaps und Sitzungswiederholungen. Außerdem ordnen wir von Ihnen auf unserer Website erteiltes Feedback und die dabei erhobenen Daten der Ihnen von Clarity zugeordneten ID zu, um Ihr Feedback anhand von Sitzungswiederholungen besser nachvollziehen zu können und darauf zielgerichteter reagieren zu können. Die mithilfe von Clarity vorgenommenen Datenverarbeitungen erfolgen um, unsere Produkte und Dienstleistungen zu verbessern und zu vermarkten. Die Nutzungsdaten der Website werden mithilfe von Cookies von Erst- und Drittanbietern und anderen Tracking-Technologien erfasst, um die Beliebtheit von Produkten/Dienstleistungen und Online-Aktivitäten zu ermitteln. Außerdem verwenden wir diese Informationen zur Optimierung der Website, zu Betrugs-/Sicherheitszwecken und für Werbung.

Die von uns mithilfe von Clarity erhobenen Daten werden auch von Microsoft erhoben. Dies erfolgt einerseits dazu, um uns die Werbeleistungen von Clarity bereitzustellen. Andererseits erhebt Microsoft auch selbst Daten für eigene Zwecke, wenn Sie Ihre Einwilligung im Cookie Banner erteilt haben. Weitere Informationen zum Datenschutz bei Microsoft finden Sie in der Microsoft-Datenschutzerklärung: [https://www.microsoft.com/de-de/privacy/privacystatement](https://www.microsoft.com/de-de/privacy/privacystatement).
...
Nähere Informationen zum Datenschutz von Optimizely finden Sie hier: [https://www.optimizely.com/legal/privacy-policy/](https://www.optimizely.com/legal/privacy-policy/).
...
Weitere Informationen über den Datenschutz bei Santander Consumer Finance und Ihre Rechte als Betroffener finden Sie hier: [https://www.santanderconsumer.com/grundlegende-informationen-zum-datenschutz/](https://www.santanderconsumer.com/grundlegende-informationen-zum-datenschutz/).

**Rechtsgrundlage:** Firewall (Imperva): berechtigtes Interesse gemäß Art. 6 Abs.. 1 lit. f) DSGVO, § 25 Abs. 2 TDDDG.

**Rechtsgrundlage:** Interaktionen & Nutzerverhalten (Google Analytics): Einwilligung, Art. 6 Abs. 1 a) DSGVO, § 25 Abs. 1 TDDDG.

**3.4 Online-Werbung**

Die Werbung auf unseren Angeboten wird durch die Verarbeitung Ihres Nutzungsverhaltens auf prognostizierte Interessen hin für Sie optimiert. Es werden dazu Cookies und funktionsähnliche Technologien verwendet, die im Speicher Ihres Internetbrowsers oder (mobilen) Endgerätes abgelegt werden und die Wiedererkennung ermöglichen. Für die bedarfsgerechte Gestaltung unserer Webeinhalte ordnen wir Sie einer Profilgruppe zu, wodurch u.a. der Umfang der angezeigten Werbeinhalte individuell angepasst wird.
...
**Rechtsgrundlage:** Einwilligung, Art. 6 Abs. 1 a) DSGVO, § 25 Abs. 1 TDDDG.; für nicht personalisierte Werbung: Berechtigtes Interesse, Art. 6 Abs. 1 f) DSGVO, § 25 Abs. 2 TDDDG.

**3.4.1.3. Widerspruch Google Advertising Products / Datenschutzinformationen von Google**

Zusätzlich zum Widerspruch zur Datenverarbeitung zu Google Advertising Products über den AutoScout24 [AutoScout24 Privacy Managers](https://www.autoscout24.de/consent-management/) bietet Google eine eigene Möglichkeit, mit der Sie dieser Verwendung Ihrer pseudonymen Daten durch Google mittels Installation eines Browser Add-ons jederzeit widersprechen können. Dieses können Sie hier runterladen: [https://support.google.com/ads/answer/7395996](https://support.google.com/ads/answer/7395996). Außerdem haben die Möglichkeit, interessenbezogenen Werbung durch Google dauerhaft zu widersprechen, wenn Sie ein Google Konto verwenden. Hierzu muss die betroffene Person von jedem der von ihr genutzten Internetbrowser aus den Link [https://adssettings.google.de/authenticated](https://adssettings.google.de/authenticated) aufrufen und dort die gewünschten Einstellungen vornehmen.

Alle Informationen zum Datenschutz von Google finden Sie hier [https://www.google.com/intl/de/policies/privacy/](https://www.google.com/intl/de/policies/privacy/).

Daneben nutzt AutoScout24 Deutschland die Dienste folgender Werbenetzwerke:

*   **Amazon Ads**

Wir nutzen zur Ausspielung nutzungsbasierter Werbung auf unseren Seiten sowie auf Webseiten Dritter den Amazon Ad-Tag der Amazon Web Services Inc. (410 Terry Avenue North, Seattle, WA 98109, USA; “Amazon Ads”). Zur Analyse des Nutzungsverhaltens werden auf unseren Websites Cookies und eine individuelle, pseudonymen Kennung („ID“) eingesetzt. Durch Auslesen der in einem Cookie gespeicherten IDs ist es möglich, Endgeräte wiederzuerkennen. Außerdem teilen wir mit Amazon Ads Event-Daten (bspw. die Information, dass ein Lead erstellt wurde) zusammen mit IDs (wie bspw. gehashten E-Mail-Adresse), um unsere Online-Werbung zielgerichtet auszugestalten. Wenn Sie bei Amazon registriert oder zumindest eingeloggt sind, kann Amazon Ads die von uns erhaltenen Event-Daten zusammen mit den IDs zuordnen und interessensbasierte Werbung anzeigen.

Nähere Informationen zum Datenschutz von Amazon Ads finden Sie hier: [https://advertising.amazon.com/de-de/resources/ad-policy/eu-data-protection-and-privacy](https://advertising.amazon.com/de-de/resources/ad-policy/eu-data-protection-and-privacy).
...
Nähere Informationen zum Datenschutz von Bing Ads finden Sie hier: [https://privacy.microsoft.com/de-de/privacystatement](https://privacy.microsoft.com/de-de/privacystatement).

**Rechtsgrundlage:** Einwilligung, Art. 6 Abs. 1 a) DSGVO, § 25 Abs. 1 TDDDG.

*   **Decentriq AG**

Wir nutzen die Dienste von Decentriq AG, Josefstr. 219, 8005 Zürich, Schweiz („Decentriq“), einem Anbieter zur kooperativen Datenanalyse. Decentriq unterstützt uns bei der Zielgruppen-Analyse, um nutzungsbasierte Werbung auf unserer sowie auf Drittwebseiten auszuspielen. Decentriq empfängt und speichert pseudonymisierte, individuelle Kennungen („IDs“), die auf Grundlage Ihrer Daten erstellt werden, wie gehashte E-Mail-Adressen. Decentriq ermöglicht die Zusammenarbeit zwischen AutoScout24 und seinen Partnern, um Erkenntnisse aus den Daten zu gewinnen und passende Online-Werbung zu ermöglichen. Decentriq konfiguriert die IDs so, dass Ihr Endgerät wiedererkannt werden kann, wenn Sie Webseiten besuchen, die diese IDs unterstützen. Dadurch können Ihnen interessenbasierte Werbeinhalte angezeigt werden - unter anderem solche, die sich auf Ihre früheren Website-Interaktionen oder identifizierten Interessen beziehen.

Weiter Informationen finden Sie hier: [https://www.decentriq.com/legal/privacy-policy#i-content-of-this-privacy-policy](https://www.decentriq.com/legal/privacy-policy#i-content-of-this-privacy-policy).

**Rechtsgrundlage:** Einwilligung, Art. 6 Abs. 1 a) DSGVO, § 25 Abs. 1 TDDDG.

*   **digitalAudience**

Wir nutzen zur Ausspielung nutzungsbasierter Werbung auf unseren Seiten sowie auf Webseiten Dritter Dienste der Social Audience B.V. (Valschermkade 18 1059 CD, Amsterdam, Niederlande; „digitalAudience“), einem Dienstleister für Onlinewerbung . digitalAudience erhebt und speichert Informationen über Ihre Aktivitäten durch das Setzen eines Cookies und einer individuellen, pseudonymen Kennung („ID“), die der Analyse Ihres Nutzerverhaltens dienen. Die ID kann auch unter Verwendung ihrer Daten erstellt werden, etwa auf Basis einer gehashten E-Mail-Adresse. Durch Auslesen der in einem Cookie gespeicherten ID ist es möglich, Ihr Endgerät wiederzuerkennen, wenn Sie Websites aufrufen, die dem Werbenetzwerk von digitalAudience angehören. Auf diesen Seiten können Ihnen dann interessengerechte Werbeanzeigen präsentiert werden, etwa solche, die sich auf Inhalte beziehen, die Sie auf zuvor auf Webseiten aufgerufen haben .

Nähere Informationen zum Datenschutz von digitalAudience finden Sie hier: [https://digitalaudience.io/legal/](https://digitalaudience.io/legal/).

**Rechtsgrundlage:** Einwilligung, Art. 6 Abs. 1 a) DSGVO, § 25 Abs. 1 TDDDG.

*   **Eyeota**

Wir nutzen auf unserer Website die Analyseplattform Eyeota. Dienstanbieter ist Eyeota Pte Ltd., Hong Kong Street #03-01, Singapur 059670 („Eyeota“). Eyeota efasst auf unserer Website pesudonymisierte Nutzungsdaten basierend auf Ihren Aktivitäten auf unserer Website. Diese Daten werden von Eyeota organisiert, gepflegt und verteilt, um gezielte Werbung zu ermöglichen. Zudem nutzen wir aggregierte Daten von Eyeota für interne Berichte, Analyse von Branchentrends und zur Marktforschung.

Singapur ist ein Drittland außerhalb der EU und unterliegt nicht der DSGVO. Zur Sicherstellung eines angemessenen Datenschutzniveaus haben wir mit Eyeota neben einem Auftragsverarbeitungsvertrag die aktuellen EU-Standardvertragsklauseln gemäß Art. 46 Abs. 2 lit. c) DSGVO (2021/914, Kommissionsbeschluss vom 4. Juni 2021) abgeschlossen.

Weitere Informationen zur Datenschutzerklärung von Eyeota finden Sie hier: [https://www.eyeota.com/privacy-center](https://www.eyeota.com/privacy-center).
...
Wenn Sie Facebook-Nutzer sind, kann Facebook durch eine Pixel-ID, das Facebook SDK, ein Facebook Cookie oder pseudonymisierte, gehashte Nutzerdaten basierend auf Ihrer E-Mail-Addresse (auch als Online-ID bekannt) den Besuch unserer Seiten und Apps Ihrem Benutzerkonto zuordnen. Als Facebook-Mitglied können Sie zudem unter https://www.facebook.com/ads/website\_custom\_audiences/ Ihre Account-Einstellungen bearbeiten und über diese geräteübergreifend der Datenerfassung via Custom Audiences widersprechen.

Nähere Informationen zum Datenschutz von Facebook finden Sie hier: [https://de-de.facebook.com/privacy/policy/](https://de-de.facebook.com/privacy/policy/).

**Rechtsgrundlage:** Einwilligung, Art. 6 Abs. 1 a) DSGVO, § 25 Abs. 1 TDDDG.

*   **ID5**

Wir nutzen auf unserer Website zum Zwecke der Ausspielung nutzungsbasierter Werbung Dienste der ID5 Technology Ltd (199 Bishopsgate, London EC2M 3TY, UK; „ID5“). ID 5 erstellt auf Grundlage Ihrer Aktivitäten auf unseren Seiten sowie anhand von Geräte- und Browsermerkmalen ein individuelles Nutzungsprofil, mittels dessen wir Ihnen interessengerichtet Werbung anzeigen können. Die Wiedererkennung erfolgt über eine individuelle Online-ID, die unter anderem auf pseudonymisierten Nutzerdaten wie einer gehashten E-Mail-Adresse basieren kann.

Nähere Informationen zum Datenschutz von ID5 finden Sie hier: [https://id5.io/platform-privacy-policy/](https://id5.io/platform-privacy-policy/).

**Rechtsgrundlage:** Einwilligung, Art. 6 Abs. 1 a) DSGVO, § 25 Abs. 1 TDDDG.

*   **Lifull Connect / Trovit**

Wir nutzen die Dienste von LIFULL CONNECT, S.L, Avenida Diagonal 579-587, Floor 5, door B, Bercola, Spanien ("Lifull Connect"), einem Unternehmen der Lifull Group (Lifull Co.Ltd.). Lifull Connect ist Betreiber einer Aggregationsplattform für Anzeigen insbesondere im Bereich Autos und betreibt die Suchmaschine Trovit, die Kleinanzeigen aus verschiedenen Quellen und insbesondere aus Autoportalen zusammenführt und gebündelt bereitstellt. Auf unserer Website wird ein Tracking-Pixel von Trovit eingesetzt. Dieser Pixel erfasst Informationen über die Nutzung unserer Website, um Lifull Connect die Analyse von Interaktionen mit den Inhalten zu ermöglichen. Dadurch können beispielsweise Anzeigen für die Nutzer relevanter und individueller gestaltet werden.

Lifull Connect verarbeitet diese Daten gemäß ihrer Datenschutzrichtlinie, die unter [https://www.lifullconnect.com/global-privacy-policy-region-2-de/](https://www.lifullconnect.com/global-privacy-policy-region-2-de/) einsehbar ist. Dabei kann es auch zu einer Übertragung von Daten in Länder außerhalb des Europäischen Wirtschaftsraums kommen. Lifull Connect stellt nach eigenen Angaben sicher, dass für diese Übertragungen angemessene Schutzmaßnahmen wie die europäischen Standardvertragsklauseln getroffen werden.

Wir verarbeiten diese Daten und leiten sie an Lifull Connect weiter, wenn Sie Ihre Einwilligung hierfür erteilt haben.
...
Wenn Sie auf unserer Website Ihre E-Mail-Adresse eingeben (um sich anzumelden, einen Newsletter zu abonnieren oder ähnliches), können wir personenbezogene oder andere Daten, die wir von Ihnen erheben, wie z. B. Ihre E-Mail-Adresse (in gehashter, pseudonymisierter Form), Ihre IP-Adresse oder Informationen über Ihren Browser oder Ihr Betriebssystem an unseren Partner LiveRamp, Inc. und seine Konzerngesellschaften weitergeben. Die Datenschutzerklärung von LiveRamp und die Möglichkeit zum Widerspruch finden Sie hier: [https://liveramp.de/privacy/datenschutzerklarung-fur-die-liveramp-dienste/](https://liveramp.de/privacy/datenschutzerklarung-fur-die-liveramp-dienste/). LiveRamp verwendet diese Informationen, um einen Online-Identifizierungscode zu erstellen, mit dem Sie auf den von Ihnen verwendeten Geräten wiedererkannt werden können. Der Code enthält keine Ihrer direkt identifizierenden personenbezogenen Daten und wird von LiveRamp nicht dazu verwendet, Sie erneut direkt wieder zu identifizieren. Wir legen den Code in unserem Cookie ab oder verwenden dazu ein LiveRamp-Cookie und lassen ihn für Online- und plattformübergreifende Werbung verwenden. Er kann mit unseren Werbepartnern und anderen Drittanbietern von Werbung weltweit geteilt werden, um interessenbasierte Inhalte oder gezielte Werbung in Ihrem gesamten Online-Erlebnis zu ermöglichen (z. B. Web, E-Mail, verbundene Geräte, Apps usw.). Diese Drittanbieter können den Code wiederum verwenden, um demografische oder interessenbasierte Informationen zu verknüpfen, die Sie bei Interaktionen mit ihnen angegeben haben. Sie haben das Recht, über unsere Nutzung von LiveRamp-Cookies und unserer Weitergabe dieser Daten an LiveRamp zu den oben genannten Zwecken zu entscheiden.

**Rechtsgrundlage:** Einwilligung, Art. 6 Abs. 1 a) DSGVO, § 25 Abs. 1 TDDDG.

*   **Lotame**

Wir nutzen zur Ausspielung nutzungsbasierter Werbung auf unseren Seiten sowie auf Webseiten Dritter Dienste der Lotame Solutions Inc. (8890 McGaw Road Suite 250, Columbia, MD 21045, USA; "Lotame"), einem Dienstleister für Onlinewerbung . Lotame erhebt und speichert Informationen über Ihre Aktivitäten durch das Setzen eines Cookies und einer individuellen, pseudonymen Kennung („ID“), die der Analyse Ihres Nutzerverhaltens dienen. Durch Auslesen der in einem Cookie gespeicherten ID ist es möglich, Ihr Endgerät wiederzuerkennen, wenn Sie Websites aufrufen, die dem Werbenetzwerk von Lotame angehören. Auf diesen Seiten können Ihnen dann interessengerechte Werbeanzeigen präsentiert werden, etwa solche, die sich auf Inhalte beziehen, die Sie auf zuvor auf Webseiten aufgerufen haben.

Nähere Informationen zum Datenschutz von Lotame finden Sie hier: [https://www.lotame.com/privacy/](https://www.lotame.com/privacy/).

**Rechtsgrundlage:** Einwilligung, Art. 6 Abs. 1 a) DSGVO, § 25 Abs. 1 TDDDG.

*   **Mediarithmics**

Unsere Website verwendet Dienste von Mediarithmics (MEDIARITHMICS SAS, 14, avenue de l'Opera - 75001 Paris, Frankreich „Mediarithmics“), einer Kundendatenplattform („CDP“). Mediarithmics und wir, die als gemeinsame Verantwortliche agieren, verarbeiten personenbezogene Daten für technische Vorgänge, um unseren Website-Besuchern personalisierte Werbung bereitzustellen, was den Abgleich pseudonymer personenbezogener Daten umfasst, bei denen es sich um Gerätekennungen (Cookie-Kennungen) auf der Grundlage Ihres Geräte-Benutzeragenten handelt zum Abgleich und zur Erstellung spezifischer Zielgruppen für die Anzeigenschaltung basierend auf dem Browsing- und Klickverhalten der Website-Besucher. Die von Mediarithmics gesetzte Gerätekennung wird in ein Cookie gespeichert, das in Ihrem Browser platziert wird, und wird mit anderen Gerätekennungen unseres Werbepartners abgeglichen. Die Daten werden mit unseren im Privacy Manager identifizierten Werbepartnern geteilt, um personalisierte Werbung auszuliefern.

Wenn Sie Ihre E-Mail-Adresse auf unserer Website oder App eingeben, um sich anzumelden oder einen Verkäufer zu kontaktieren, können wir Ihre E-Mail-Adresse (in gehashter, pseudonymisierter Form) zusammen mit anderen personenbezogenen Daten, die wir über Sie haben und die auf der CDP-Plattform von Mediarithmics gespeichert sind, verwenden Sie auf den von Ihnen verwendeten Geräten wiederzuerkennen. In einem solchen Fall agieren wir als Datenverantwortlicher und Mediarithmics als Datenverarbeiter.

Nähere Informationen zum Datenschutz von Mediarithmics finden Sie hier: [https://www.mediarithmics.io/legal/data-policy](https://www.mediarithmics.io/legal/data-policy).
...
Wenn Sie TikTok-Nutzer sind, kann TikTok durch eine Pixel-ID, das TikTok-SDK, sowie ein TikTok-Cookie den Besuch unserer Websites und Apps Ihrem Benutzerkonto zuordnen. Als TikTok-Mitglied können Sie zudem unter [https://www.tiktok.com/legal/cookie-settings?lang=de-DE](https://www.tiktok.com/legal/cookie-settings?lang=de-DE) Ihre Account-Einstellungen bearbeiten und über diese geräteübergreifend der Datenerfassung via Custom Audiences widersprechen.  
Nähere Informationen zum Datenschutz von TikTok finden Sie hier: [https://www.tiktok.com/legal/page/eea/privacy-policy/de-DE](https://www.tiktok.com/legal/page/eea/privacy-policy/de-DE).

**Rechtsgrundlage:** Einwilligung, Art. 6 Abs. 1 a) DSGVO, § 25 Abs. 1 TDDDG.

*   **zeotap**

Wir haben auf unseren Angeboten Komponenten der zeotap Data GmbH, Karl-Liebknecht-Str.32,10178 Berlin („zeotap“) integriert. zeotap ist ein Plattform-Anbieter mit Kernkompetenzen im Bereich Online-IDs. Über zeotap ist es uns möglich, Besucher unserer Internetseite gezielt mit personalisierter, interessenbezogener Werbung geräteübergreifend anzusprechen. Dafür erhält zeotap ggf. u.a. folgende Kategorien von Nutzer-Daten: IDs mobiler Endgeräte, Cookie-IDs, gehashte (pseudonymisierte) E-Mail-Adressen. Darüber hinaus verwendet zeotap unter Umständen Cookies, Pixel und ähnliche Tools, um selbst Online-IDs von Usern oder Cookie-Kennungen zu erheben.

Weitere Informationen zum Datenschutz bei zeotap finden Sie unter: [https://www.zeotap.com/privacy-policy/](https://www.zeotap.com/privacy-policy/).
...
**3.9 Datenaustausch mit Unternehmen, an denen AutoScout eine Beteiligung hat**
...
**5\. Beabsichtigen wir, Ihre Daten in ein Drittland zu übermitteln?**
...
Bitte beachten Sie, dass mit einem Widerspruch der Versand des Newsletters beendet wird. Ihren Widerspruch zu Newslettern und Mailings richten Sie bitte an: [widerspruch@autoscout24.de](mailto:widerspruch@autoscout24.de)
...
**8\. Was sollten Sie bei dem Umgang mit den Daten anderer Nutzer beachten?**
...
Tölzer Straße 16  
82031 Grünwald  
[as24-datenschutz@autoscout24.com](mailto:as24-datenschutz@autoscout24.com)

**10\. Verarbeitungen bei smyle**

Wenn Sie über smyle ein Auto erwerben wollen oder erworben haben, ist smyle für die Verarbeitung Ihrer personenbezogenen Daten eigenständig verantwortlich (siehe Ziffer 1.4). Im Rahmen der Bereitstellung von Angeboten arbeitet smyle auch mit Autoscout24 Deutschland zusammen. Teilweise erfolgt die Verarbeitung Ihrer personenbezogenen Daten daher in gemeinsamer Verantwortung von smyle und AutoScout24 Deutschland.
...
**10.1 Zu welchen Zwecken und auf welcher Rechtsgrundlage verarbeitet smyle Ihre Daten als eigenständiger Verantwortlicher?**

**10.1.1 Zur Anbahnung und Durchführung von Bestellungen und ggf. in Anspruch genommener Zusatzservices**
...
**10.2 Zu welchen Zwecken und auf welcher Rechtsgrundlage verarbeitet smyle Ihre Daten gemeinsam mit AutoScout24 Deutschland?**

**10.2.1. Durchführung des Bestellvorgangs / Verwaltung von Kunden-Accounts**  
...
**10.2.2. Zur Erstellung individueller Produktempfehlungen einschließlich E-Mail-Werbung**
...
**10.2.3. Zur Bereitstellung des Kundensupports einschließlich der Gewährleistung von Betroffenenrechten**  
...
**10.3. An welche Empfänger geben wir Ihre Daten weiter**
...
*   Zulassung des Fahrzeugs durch Dienstleister bei der Zulassungsbehörde: DAD (weitere Informationen zum Datenschutz bei DAD: [https://www.dad.de/datenschutz/](https://www.dad.de/datenschutz/));
*   Garantie-Versicherung: Allianz (weitere Informationen zum Datenschutz bei der Allianz: [https://policierung.allianz-warranty.com/teslaSales/util/downloadDataUsage](https://policierung.allianz-warranty.com/teslaSales/util/downloadDataUsage));
*   Lieferung des Fahrzeugs: Kroschke (weitere Informationen zum Datenschutz bei Kroschke: [https://www.kroschke.de/datenschutz/](https://www.kroschke.de/datenschutz/));
*   Finanzierungskauf: Santander Bank (weitere Informationen zum Datenschutz bei der Santander Bank: [https://www.santander.de/privatkunden/service-kontakt/datenschutz/](https://www.santander.de/privatkunden/service-kontakt/datenschutz/));
*   Soweit Smyle als eigenständiger Verantwortlicher tätig ist (siehe Ziffer 10.1), wird AutoScout24 Deutschland in Bezug auf einzelne Verarbeitungen als Auftragsverarbeiter eingesetzt. Das gilt insbesondere in Bezug auf Verarbeitungen, die im Zusammenhang mit der Bereitstellung der technischen Infrastruktur und der Gewährleistung der IT-Sicherheit erfolgen.

Zudem kann in den unter Ziffer 10.1.2. beschriebenen Fällen eine Weitergabe Ihrer personenbezogenen Daten an öffentliche Stelle, wie der Staatsanwaltschaft erforderlich sein. Darüber hinaus arbeitet smyle bzw. AutoScout24 Deutschland mit Rechtsanwälten und Beratern zusammen, die je nach Bedarf bei der Umsetzung rechtlicher Verpflichtungen unterstützen.

**10.4. Wie lange speichern wir Ihre Daten?**
...
**10.5. Welche Rechte haben Sie als betroffene Person?**
...
Widerrufe zu Einwilligungen und Widersprüche zu Verarbeitungen können darüber hinaus zentral an [widerspruch@autoscout24.de](mailto:widerspruch@autoscout24.de) adressiert werden.

**10.6. Was bedeutet die gemeinsame Verantwortlichkeit für mich als betroffene Person?**

Wie unter Ziffer 10.2 im Detail beschrieben führen smyle und AutoScout24 Deutschland einige Verarbeitungen als gemeinsame Verantwortliche durch. Zu diesem Zweck wurde ein Vertrag abgeschlossen, der vor allem festlegt, wer welche Pflichten aus der DSGVO erfüllt.
